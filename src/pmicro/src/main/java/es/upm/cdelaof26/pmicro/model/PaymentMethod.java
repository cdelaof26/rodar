...
public class PaymentMethod extends RepresentationModel<PaymentMethod> {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Schema(description = "Identificador autoincremental", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Integer id;
    
    @Schema(description = "Nombre del tipo de pago", pattern = ".{1,128}", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
